<div id="sikakus-header" class="text-center mb-10">
  <img class="mw-50 w-100px mb-5" src="{{ asset('media/categories/gokigen.png') }}">

  <h3 class="pb-3">Gokigen Options</h3>
</div>
...
<div class="form-group row mb-10">
  ...
  <div class="col-lg-4 col-md-9 col-sm-12">
    <div class="dropdown bootstrap-select form-control">
      <select class="form-control selectpicker" data-style="btn-light-info" data-container="body" id="gokigenDifficulty">
        @foreach (config('gokigens.difficulties') as $difValue => $difName)
  ...
  <div class="col-lg-4 col-md-9 col-sm-12">
    <div class="dropdown bootstrap-select form-control">
      <select class="form-control selectpicker" data-style="btn-light-info" data-container="body" id="gokigenNumber">
        @foreach (config('gokigens.addGroups') as $amount)
          <option value="{{ $amount }}">{{ $amount }} Gokigens</option>
        @endforeach
      </select>
    </div>
  </div>
...
<div class="form-group row justify-content-end card-footer">
  ...
  <button class="col-lg-4 col-md-4 col-sm-4 btn btn-light-primary font-weight-bold mr-2" type="button" data-dismiss="modal" id="addGokigensButton">
