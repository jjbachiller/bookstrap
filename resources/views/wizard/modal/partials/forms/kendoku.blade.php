<div id="sikakus-header" class="text-center mb-10">
  <img class="mw-50 w-100px mb-5" src="{{ asset('media/categories/kendoku.png') }}">

  <h3 class="pb-3">Kendoku Options</h3>
</div>
...
<div class="form-group row mb-10">
  ...
  <div class="col-lg-4 col-md-9 col-sm-12">
    <div class="dropdown bootstrap-select form-control">
      <select class="form-control selectpicker" data-style="btn-light-info" data-container="body" id="kendokuDifficulty">
        @foreach (config('kendokus.difficulties') as $difValue => $difName)
  ...
  <div class="col-lg-4 col-md-9 col-sm-12">
    <div class="dropdown bootstrap-select form-control">
      <select class="form-control selectpicker" data-style="btn-light-info" data-container="body" id="kendokuNumber">
        @foreach (config('kendokus.addGroups') as $amount)
          <option value="{{ $amount }}">{{ $amount }} Kendokus</option>
        @endforeach
      </select>
    </div>
  </div>
...
<div class="form-group row justify-content-end card-footer">
  ...
  <button class="col-lg-4 col-md-4 col-sm-4 btn btn-light-primary font-weight-bold mr-2" type="button" data-dismiss="modal" id="addKendokusButton">
