...
<div class="form-group row mb-10">
  ...
  <div class="col-lg-4 col-md-9 col-sm-12">
    <div class="dropdown bootstrap-select form-control">
      <select class="form-control selectpicker" data-style="btn-light-info" data-container="body" id="roundaboutNumber">
        @foreach (config('roundabouts.addGroups') as $amount)
          <option value="{{ $amount }}">{{ $amount }} Round Abouts</option>
        @endforeach
      </select>
    </div>
  </div>
