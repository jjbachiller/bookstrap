          ...
          <div class="row justify-content-center text-center my-0 my-md-25">
            ...
            <div class="col-md-4 col-xxl-3 bg-white rounded-right shadow-sm">
              <div class="pt-25 pb-25 pb-md-10 px-4">
                ...
                <a href="https://puzzlebookcompiler.com/members/product/LCBW-Starter" type="button" class="btn btn-primary text-uppercase font-size-lg font-weight-bolder px-15 py-3">Subscribe</a>
              </div>
            </div>
      			<!-- end: Pricing-->
    			...
    			<div class="col-md-4 col-xxl-3 bg-primary my-md-n15 rounded shadow-sm">
    				<div class="pt-25 pt-md-37 pb-25 pb-md-10 py-md-28 px-4">
    					...
    					<a href="https://puzzlebookcompiler.com/members/product/LCBW-Silver" type="button" class="btn btn-white text-uppercase font-size-lg font-weight-bolder px-15 py-3">Subscribe</a>
    				</div>
    			</div>
    			<!-- end: Pricing-->
    			...
    			<div class="col-md-4 col-xxl-3 bg-white rounded-right shadow-sm">
    				<div class="pt-25 pb-25 pb-md-10 px-4">
    					...
    					<a href="https://puzzlebookcompiler.com/members/product/LCBW-Gold" type="button" class="btn btn-primary text-uppercase font-size-lg font-weight-bolder px-15 py-3">Subscribe</a>
    				</div>
    			</div>
    			<!-- end: Pricing-->
    		</div>
